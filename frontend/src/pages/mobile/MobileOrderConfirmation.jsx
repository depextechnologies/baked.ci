  ...
  return (
    <div className="pb-32">
      ...
      <div className="px-4 pt-2 pb-3 flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0 text-base font-bold">{t("checkout.order_success_title")}</div>
      ...
      <div className="px-4">
        <div className="baked-card relative overflow-hidden p-6 text-center border" style={{
          ...
          <div className="relative">
            ...
            <div className="text-2xl font-bold mt-3">{t("checkout.order_success_title")}</div>
      ...
      <div className="fixed bottom-16 left-0 right-0 z-30 bg-card border-t border-border pb-[env(safe-area-inset-bottom)]">
        <div className="grid grid-cols-2 gap-2 p-3">
          <Button data-testid="m-oc-continue" onClick={() => nav("/")} variant="outline" className="baked-btn h-12 font-semibold">{t("cart.continue_shopping")}</Button>
